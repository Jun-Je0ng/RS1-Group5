...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument('robot_z', default_value='0.4'))
    ld.add_action(DeclareLaunchArgument('robot_yaw', default_value='0.0'))  # radians
    ...
    # Publish odom -> base_link transform (robot_localization EKF)
